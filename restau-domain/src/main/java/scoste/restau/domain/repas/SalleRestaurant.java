...
import scoste.restau.domain.repas.Repas;
import scoste.restau.domain.repas.StatusRepas;
...
import scoste.restau.event.value.EventErrorValue;
...
import static scoste.restau.event.EventType.LIBERE_TABLE;
